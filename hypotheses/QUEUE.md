...
>
> **Excepción registrada y CERRADA (2026-08-29):** H009 (AMT continuación) — la cara opuesta de H008
> (aceptación→continuación) — se corrió como test de CIERRE de la última cara abierta de la familia AMT
> (datos ya descargados, holdout NO tocado, probabilidad previa BAJA). Resultado: **MUERTA / NO VIABLE**
> (Sharpe activo −1.190 ≪ listón 1.560, `docs/h009_run.md`). La familia AMT queda COMPLETA: ambas caras
> negativas (fade H008 −0.067, continuación H009 −1.190); los niveles de perfil no son redundantes pero
> la regla de subasta no da edge. La cola sigue VACÍA de candidatos viables; el veredicto del programa
> (nueve familias, cero supervivientes) NO cambia.
...
| **H009** | AMT continuación (cripto) | microstructure | **MUERTA / NO VIABLE** (corrida 2026-08-29, `docs/h009_run.md`) | La CARA OPUESTA de H008: ACEPTACIÓN fuera del VA → continuación (momentum), no rechazo→reversión. Mecanismo económico INVERSO, no caza de variantes. Duty real 0.092 (< estimado 0.15) → listón activo **1.560** (no 1.28). T efectiva **73** (coincidencia real BTC/ETH: 37 solo + 1.11×32 pares; la cota cruda 56 disparó una PARADA falsa, corregida) → RESOLUBLE. **Sharpe activo perfil −1.190 ≪ listón 1.560 → falsador cond. 3 (NO VIABLE).** Δ perfil−simple +4.325 (IC no cruza 0) → los niveles de perfil NO son redundantes, pero la REGLA de subasta no da edge. Nulo: objetivo 9% (sanidad ~50% falla) → geometría marcada ROTA por objetivo LEJANO (±1×rango_VA), NO el defecto de H008 (objetivo detrás); (2) no usada por conservadurismo, el veredicto no depende de ella. Expectativa: dirección CUMPLIDA (muerta), magnitud REFUTADA (−1.190 fuera de −0.3..+0.3, peor de lo esperado). Holdout INTACTO. **Familia AMT COMPLETA: ambas caras negativas (fade H008 −0.067, continuación H009 −1.190).** Ficha `hypotheses/H009_amt_continuation.yaml`. |
