...
| **H007** | TSMOM sobre universo ampliado (17) | trend | **pre_registrada** (2026-08-22) | Segunda mirada al efecto de H001 sobre el universo de 17 (señal `tsmom` sin modificar). **Holdout RESPETADO** (in-sample → 2023-08-16): la selección del universo tras ver morir a H001 es descubrimiento, no replicación. El punto real: `calibracion_del_marco` (testear si Grinold-Kahn/N_eff predice; falló ~35%). Veredicto esperado: muerta. Ficha `hypotheses/H007_tsmom_expanded.yaml`. Revisada → falta implementar. |
