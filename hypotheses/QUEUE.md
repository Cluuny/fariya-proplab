...
| **H007** | TSMOM sobre universo ampliado (17) | trend | **pre_registrada** (2026-08-22) | Segunda mirada al efecto de H001 sobre el universo de 17 (señal `tsmom` sin modificar), justificada por argumento externo. El punto real: `calibracion_del_marco` — testear si Grinold-Kahn/N_eff predice (falló ~35% con N_eff). Veredicto esperado: muerta. Ficha `hypotheses/H007_tsmom_expanded.yaml`. Falta revisar → implementar. |
