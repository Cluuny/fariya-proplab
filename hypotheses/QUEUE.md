...
| H002 | Carry (diferencial de tasas) | carry | **RECHAZADA-POR-COSTE** | Filtro #6 (duty 100% → requerido 0.64): bruto medido 0.495 (spot+carry), neto 0.282 — el mejor del proyecto pero corto. Además concentración short-JPY (N_eff 3.41, no es cartera es posición; carry = compensación por crash). Ver `docs/queue_triage.md`. |
