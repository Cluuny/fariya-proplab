...
| H002 | Carry (diferencial de tasas) | carry | **desbloqueada** (swap direccional, 2026-08-22) | El swap ya tiene dirección (carry con signo + margen), calibrado con datos reales (change directional-swap). El diferencial con signo ya es representable → H002 es implementable. |
